...
export class Backend implements backendInterface {
    ...
    async createClip(arg0: string, arg1: string, arg2: string): Promise<Clip> {
        if (this.processError) {
            try {
                const result = await this.actor.createClip(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getClip(arg0: string): Promise<Clip> {
        if (this.processError) {
            try {
                const result = await this.actor.getClip(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateClipContent(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateClipContent(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
